 ...
 * 
 * Let's start practicing simple things, like classes and styles.
 * Under the labs/a6 folder, create another folder called classes and create
 * the following component and styling files.
 */
